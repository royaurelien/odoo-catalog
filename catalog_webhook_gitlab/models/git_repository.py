...
class GitRepository(models.Model):
    ...
    def _convert_gitlab_webhook_to_odoo(self, data, **kwargs):
        ...
        vals = {
            ...
            'created_at': deep_get(data, 'object_attributes.created_at', False, _gitlab_date_to_datetime),
            'updated_at': deep_get(data, 'object_attributes.updated_at', False, _gitlab_date_to_datetime),
        ...
        if event_type == "merge_request":
            vals['merge_request'] = {
                'target_branch': deep_get(data, 'object_attributes.target_branch', False),
                'source_branch': deep_get(data, 'object_attributes.source_branch', False),

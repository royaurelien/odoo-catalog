...
class GitOrganization(models.Model):
    ...
    allow_repository_create = fields.Boolean(default=False, string="Allow repository create")
    ...
    default_visibility = fields.Selection([('public', 'Public'), ('internal', 'Internal'), ('private', 'Private')], string="Default visibility")
    default_namespace_id = fields.Many2one(comodel_name='git.namespace', string="Default namespace")

    namespace_ids = fields.One2many(comodel_name='git.namespace', inverse_name='organization_id', string="Namespaces")
